...
namespace DSEV.Schemas
{
    ...
    public class HikeGigE : 그랩장치
    {
        ...
        public override Boolean SoftwareTrigger() => 그랩제어.Validate($"{this.구분} TriggerSoftware", Camera.SetCommandValue("TriggerSoftware"), true);
        ...
        {
            Debug.WriteLine("ImageCallback");
            this.AcquisitionFinished(surfaceAddr, frameInfo.nWidth, frameInfo.nHeight);
            //this.Stop();
        }

        public void GrabCont(string folderPath, int WaitSeconds, int num)
        {
